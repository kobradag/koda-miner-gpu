...
use cust::prelude::*;
use kobra_miner::xoshiro256starstar::Xoshiro256StarStar;
...
static PTX_86: &str = include_str!("../resources/kobra-cuda-sm86.ptx");
static PTX_75: &str = include_str!("../resources/kobra-cuda-sm75.ptx");
static PTX_61: &str = include_str!("../resources/kobra-cuda-sm61.ptx");
//static PTX_30: &str = include_str!("../resources/kobra-cuda-sm30.ptx");
//static PTX_20: &str = include_str!("../resources/kobra-cuda-sm20.ptx");
